    ...
    <body>
        ...
        <div class="container">
            <div class="dataContainer">
                <h3>Assistência Nº <?php echo($assistanceData->getId());?></h3>

                <div class="dataContent">
                    <h4>Data inicial: <span><?php echo($assistanceData->getInitialDate());?></span></h4>
                    <h4>Data final: <span><?php echo($assistanceData->getFinalDate());?></span></h4>
                    
                    <textarea readonly class="textarea"><?php echo($assistanceData->getDescription());?></textarea>
                    <textarea readonly class="textarea"><?php echo($assistanceData->getGoals());?></textarea>

                    <h4>Front-office: <span><?php echo($assistanceData->getFrontOffice());?></span></h4>
                    <h4>Tipo de ocorrência: <span><?php echo($assistanceData->getTypeName());?></span></h4>
                    <h4>Técnico: <span><?php echo($assistanceData->getTechnicalName());?></span></h4>
                    <h4>Equipamento alvo: <span><?php echo($assistanceData->getEquipmentName());?></span></h4>
                </div>
            </div>
        </div>
        ...
        </div><div class="modalFilter" id="modalFilter">
            <!--MODALS TO SIDEBAR -->
            <div data-actionBtn="updateEquipmentBtnAction" id="updateEquipment" class="equipmentModal modalContent updateEquipment">
                <h3>Olá, qual equipamento você quer atualizar?</h3>
