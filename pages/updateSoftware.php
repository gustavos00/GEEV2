...
<head>
    ...
    <nav class="sidebar">
            ...
            <div class="container">
                ...
                <form id="form" data-cookieName="__geeupdatesoftware" action="<?php getUrl('/actions/updateSoftware.php'); ?>" method="post">
                    ...
                    <div class="dataContainer">
                        ...
                        <input value=<?= $specific->getFinalDate()?> class="input" type="date" name="finalDate" id="finalDate">
        ...
        <div class="modalFilter" id="modalFilter">
            ...
            <!--MODALS TO CURRENT PAGE -->

            <div class="softwareModal createSoftwareType modalContent" id="createSoftwareType">
