...
<head>
    ...
    <title>Atualizar fornecedor - GEE</title>
</head>
    <body>
        ...
        <div class="contentWrap">
            <div class="container">
                <h1>Atualizar fornecedor</h1>
                    <?php
                    if (isset($_SESSION['updateProviderError'])) {
                        echo '
                        <div class="alert">
                            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                ' . $_SESSION['updateProviderError'] . '
                                <button type="button" class="btn-close unsetSessionVariable" data-session-name="updateProviderError" data-bs-dismiss="alert"></button>
                            </div>
                        </div>
                        ';
                    }
                ...
                <form id="form" data-cookieName="__geeupdateprovider">
                    <div class="dataContainer">
                        <input type="hidden" id="id" name="id" value="<?php echo($providerData->getId());?>">
                        <input class="input" value="<?php echo($providerData->getName()); ?>" placeholder="Nome" type="text" name="nameProvider" id="nameProvider">

                        <textarea class="textarea" placeholder="Observações" name="obsProvider" id="obsProvider" cols="30" rows="10"><?php echo($providerData->getObs()); ?></textarea>
                    </div>

                    <div class="dataContainer">
                        <div class="inputsContainer">
                            <input class="input" placeholder="Contacto" type="text" name="contactsInput" id="contactsInput">
                    ...
                    <input id="createProviderBtn" type="submit" value="Atualizar fornecedor" class="btn">
                </form>
            </div>
        </div>
